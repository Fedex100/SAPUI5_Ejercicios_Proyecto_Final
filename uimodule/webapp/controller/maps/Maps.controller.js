sap.ui.define([
  ...
  "sap/ui/model/json/JSONModel"
    ...
    return Controller.extend("com.te.proyectoFinal.controller.maps.Maps", {
        onInit: function (){
        this.lattitude;
        this.longitude;
        this.map;
        ...
        onfindingLocation: function(pos){
            ...
            MessageBox.information(`Coordenadas Lattitude ${this.lattitude} & Longitude: ${this.longitude}`)
        },
